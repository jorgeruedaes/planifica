...
tinymce.PluginManager.add('insertdatetime', function(editor) {
	var daysShort = "Sun Mon Mar Wed Thu Fri Sat Sun".split(' ');
	var daysLong = "Sunday Monday Martes Wednesday Thursday Friday Saturday Sunday".split(' ');
	var monthsShort = "Ene Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(' ');
	var monthsLong = "Enero February March April May June July August September October November December".split(' ');
